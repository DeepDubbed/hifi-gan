...
def train(rank, a, h):
    ...
    for epoch in range(max(0, last_epoch), a.training_epochs):
        ...
        for i, batch in enumerate(train_loader):
            ...
            y_g_hat = generator(x)
            y_g_hat_mel = mel_spectrogram(y_g_hat.squeeze(1), h.n_fft, h.num_mels_loss, h.sampling_rate, h.hop_size, h.win_size,
                ...
                if steps % a.validation_interval == 0:  # and steps != 0:
                    ...
                    with torch.no_grad():
                        for j, batch in enumerate(validation_loader):
                            ...
                            y_mel = torch.autograd.Variable(
                                y_mel.to(device, non_blocking=True))
                            y_g_hat_mel = mel_spectrogram(y_g_hat.squeeze(1), h.n_fft, h.num_mels_loss, h.sampling_rate,
                            ...
                            if j <= 4:
                                ...
                                y_hat_spec = mel_spectrogram(y_g_hat.squeeze(1), h.n_fft, h.num_mels_loss,
...
def main():
    ...
    parser.add_argument('--input_wavs_dir',
                        default='/home/mihai/data/deepdubbed/wavs')
    parser.add_argument('--input_mels_dir',
                        default='/home/mihai/data/deepdubbed/mels')
    parser.add_argument('--input_training_file',
                        default='/home/mihai/data/deepdubbed/training.txt')
    parser.add_argument('--input_validation_file',
                        default='/home/mihai/data/deepdubbed/validation.txt')
    parser.add_argument('--checkpoint_path', default='cp_hifigan')
    parser.add_argument('--config', default='')
    parser.add_argument('--training_epochs', default=4000, type=int)
